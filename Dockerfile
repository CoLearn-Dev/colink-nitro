...
ENTRYPOINT ip addr add 127.0.0.1/32 dev lo && ip link set dev lo up && socat vsock-listen:5000,reuseaddr,fork tcp-connect:127.0.0.1:8080 & cd root ; ./.colink/colink-server --address "127.0.0.1" --port 8080